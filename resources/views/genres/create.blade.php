                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-6 col-lg-12">
                                    {!! Form::open(['route' => 'genres.store', 'data-parsley-validate' => '', 'files' => true, 'method' => 'POST  ']) !!}
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <input id="name"  name="name" type="text" class="form-control date-inputmask" placeholder="Title"
                                            />
                                        </div>
                                    </fieldset>
